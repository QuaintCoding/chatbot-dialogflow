...
function EngineeringCollegeComponent(message) {
    ...
    const department5 = list_department[4].structValue.fields;
            ...
            description={
                <div>
                    <List>
                        ...
                        <List.Item onClick={() => {
                            textQuery(department5.text.stringValue)
                        }}>
                            <List.Item.Meta
                                title={department5.text.stringValue}
                            />
                        </List.Item>
                    </List>
                </div>
...
export default EngineeringCollegeComponent;